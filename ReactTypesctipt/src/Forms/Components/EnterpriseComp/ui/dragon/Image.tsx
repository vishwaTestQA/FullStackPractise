...
import img from './Straight_line.jpg'
import './Image.css'
...
const Image = () => {
    ...
    useEffect(() => {
       ...
       window.addEventListener('keyup', handleDino)

       return () => {
         clearInterval(interval.current)
         window.removeEventListener('keyup', handleDino)
       }
    },[])
